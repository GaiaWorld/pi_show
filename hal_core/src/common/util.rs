...
pub fn pixe_size(pformat: PixelFormat, dformat: DataFormat) -> usize {
    match (pformat, dformat) {
        (PixelFormat::RGBA, DataFormat::Byte) | (PixelFormat::RGBA, DataFormat::UnsignedByte) => 4,
        (PixelFormat::RGBA, DataFormat::Short) | (PixelFormat::RGBA, DataFormat::UnsignedShort) => {
            8
        }
        ...
        (PixelFormat::RGB, DataFormat::Byte) | (PixelFormat::RGB, DataFormat::UnsignedByte) => 3,
        (PixelFormat::RGB, DataFormat::Short) | (PixelFormat::RGB, DataFormat::UnsignedShort) => 6,
        (PixelFormat::RGB, DataFormat::Int)
        | (PixelFormat::RGB, DataFormat::UnsignedInt)
        | (PixelFormat::RGB, DataFormat::Float) => 9,

        (PixelFormat::ALPHA, DataFormat::Byte) | (PixelFormat::ALPHA, DataFormat::UnsignedByte) => {
            1
        }
