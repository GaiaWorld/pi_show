...
use render_target::{NullRenderTargetImpl};
...
impl Context for NullContextImpl {
    ...
    fn create_render_target(&mut self, _w: u32, _h: u32, _format: &PixelFormat, _has_depth: bool) -> Result<Self::ContextRenderTarget, String> {
