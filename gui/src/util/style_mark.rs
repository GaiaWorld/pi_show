...
// use bevy_ecs::prelude::{Query, Entity};
// use hal_core::*;
// use flex_layout::*;
// use share::Share;
...
// //             show: Show::default(),
// // 			dirty_list: DirtyList::default(),
// //             mark: PhantomData,
// //         }
// //     }

// // 	pub fn set_local_dirty() {
...
// ) {
// 	if let Ok(style_mark) = style_marks.get_mut(id) {
...
// {
//     type ReadData = ();
//     type WriteData = (&'a mut Query<&mut StyleMark>, &'a mut SingleCaseImpl<DirtyList>);
