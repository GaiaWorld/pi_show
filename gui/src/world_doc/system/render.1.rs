...
//         component_mgr.node.transform._group.register_handler(Rc::downgrade(&(system.clone() as Rc<ComponentHandler<Transform, WorldDocMgr>>)));
//         component_mgr.node.position._group.register_handler(Rc::downgrade(&(system.clone() as Rc<ComponentHandler<Vector3, WorldDocMgr>>)));
//         system
//     }
// }

// impl ComponentHandler<Transform, WorldDocMgr> for WorldMatrix{
...
// impl ComponentHandler<Vector3, WorldDocMgr> for WorldMatrix{
//     fn handle(&self, event: &Event, component_mgr: &mut WorldDocMgr){
...
// fn modify_matrix(node_id: usize, component_mgr: &mut WorldDocMgr) {
//     // 设置脏标志
//     {
...
// // #[cfg(test)]
// // fn test_world_matrix(world: &mut World<WorldDocMgr, ()>){
