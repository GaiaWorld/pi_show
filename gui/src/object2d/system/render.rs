...
use object2d::system::render_util::sdf;

pub struct Render(RefCell<RenderImpl>);

impl System<(), Object2dMgr> for Render{
...
impl Render {
    pub fn init(_component_mgr: &mut Object2dMgr) -> Rc<Render>{
...
impl RenderImpl {
    pub fn new() -> RenderImpl{
     ...
     pub fn render(&mut self, mgr: &mut Object2dMgr) {
        self.list_obj(mgr);
    ...
    //对不透明物体和透明物体排序
    fn list_obj(&mut self, mgr: &mut Object2dMgr){
