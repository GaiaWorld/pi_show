...
//         component_mgr.node.transform._group.register_handler(Rc::downgrade(&(system.clone() as Rc<ComponentHandler<Transform, DocumentMgr>>)));
//         component_mgr.node.position._group.register_handler(Rc::downgrade(&(system.clone() as Rc<ComponentHandler<Vector3, DocumentMgr>>)));
//         system
//     }
// }

// impl ComponentHandler<Transform, DocumentMgr> for WorldMatrix{
...
// impl ComponentHandler<Vector3, DocumentMgr> for WorldMatrix{
//     fn handle(&self, event: &Event, component_mgr: &mut DocumentMgr){
...
// fn modify_matrix(node_id: usize, component_mgr: &mut DocumentMgr) {
//     // 设置脏标志
//     {
...
// // use wcs::world::{World};
// // #[cfg(test)]
// // use generic_component::math_component::{Vector3};
...
// // #[cfg(test)]
// // fn test_world_matrix(world: &mut World<DocumentMgr, ()>){
