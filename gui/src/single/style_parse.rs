...
//             }
//             class.class_style_mark1 |= StyleType::MaskImage as usize;
//         }
//         "mask-image-clip" => {
//             class.attrs3.push(Attribute3::MaskImageClip(unsafe {
//                 transmute(f32_4_to_aabb(parse_percent_to_f32_4(value, " ")?))
//             }));
//             class.class_style_mark1 |= StyleType::MaskImageClip as usize;
//         }
//         "blend-mode" => {
...
//             class.class_style_mark2 |= StyleType::Width as usize;
//         }
//         "height" => {
//             class.attrs2.push(Attribute2::Height(parse_unity(value)?));
//             class.class_style_mark2 |= StyleType::Height as usize;
//         }
//         "left" => {
//             class.attrs2.push(Attribute2::PositionLeft(parse_unity(value)?));
//             class.class_style_mark2 |= StyleType::PositionLeft as usize;
//         }
//         "bottom" => {
//             class.attrs2.push(Attribute2::PositionBottom(parse_unity(value)?));
//             class.class_style_mark2 |= StyleType::PositionBottom as usize;
//         }
//         "right" => {
//             class.attrs2.push(Attribute2::PositionRight(parse_unity(value)?));
//             class.class_style_mark2 |= StyleType::PositionRight as usize;
//         }
//         "top" => {
//             class.attrs2.push(Attribute2::PositionTop(parse_unity(value)?));
//             class.class_style_mark2 |= StyleType::PositionTop as usize;
//         }
//         "margin-left" => {
//             class.attrs2.push(Attribute2::MarginLeft(parse_unity(value)?));
//             class.class_style_mark2 |= StyleType::MarginLeft as usize;
//         }
//         "margin-bottom" => {
//             class.attrs2.push(Attribute2::MarginBottom(parse_unity(value)?));
//             class.class_style_mark2 |= StyleType::MarginBottom as usize;
//         }
//         "margin-right" => {
//             class.attrs2.push(Attribute2::MarginRight(parse_unity(value)?));
//             class.class_style_mark2 |= StyleType::MarginRight as usize;
//         }
//         "margin-top" => {
//             class.attrs2.push(Attribute2::MarginTop(parse_unity(value)?));
//             class.class_style_mark2 |= StyleType::MarginTop as usize;
//         }
//         "margin" => {
...
//             class.class_style_mark2 |= StyleType::MarginTop as usize
//                 | StyleType::MarginRight as usize
//                 | StyleType::MarginBottom as usize
//                 | StyleType::MarginLeft as usize;
//         }
//         "padding-left" => {
//             class.attrs2.push(Attribute2::PaddingLeft(parse_unity(value)?));
//             class.class_style_mark2 |= StyleType::PaddingLeft as usize;
//         }
//         "padding-bottom" => {
//             class.attrs2.push(Attribute2::PaddingBottom(parse_unity(value)?));
//             class.class_style_mark2 |= StyleType::PaddingBottom as usize;
//         }
//         "padding-right" => {
//             class.attrs2.push(Attribute2::PaddingRight(parse_unity(value)?));
//             class.class_style_mark2 |= StyleType::PaddingRight as usize;
//         }
//         "padding-top" => {
//             class.attrs2.push(Attribute2::PaddingTop(parse_unity(value)?));
//             class.class_style_mark2 |= StyleType::PaddingTop as usize;
//         }
//         "padding" => {
//             let [r1, r2, r3, r4] = parse_four_f32(value)?;
...
//             class.class_style_mark2 |= StyleType::PaddingTop as usize
//                 | StyleType::PaddingRight as usize
//                 | StyleType::PaddingBottom as usize
//                 | StyleType::PaddingLeft as usize;
//         }
//         "border-left" => {
...
//             class.class_style_mark2 |= StyleType::BorderLeft as usize;
//             class.class_style_mark |= StyleType::BorderColor as usize;
//         }
//         "border-bottom" => {
//             let r = parse_border(value)?;
//             class.attrs2.push(Attribute2::BorderBottom(r.0));
//             class.class_style_mark2 |= StyleType::BorderBottom as usize;
//         }
//         "border-right" => {
//             let r = parse_border(value)?;
//             class.attrs2.push(Attribute2::BorderRight(r.0));
//             class.class_style_mark2 |= StyleType::BorderRight as usize;
//         }
//         "border-top" => {
//             let r = parse_border(value)?;
//             class.attrs2.push(Attribute2::BorderTop(r.0));
//             class.class_style_mark2 |= StyleType::BorderTop as usize;
//         }
//         "border" => {
//             let r = parse_border(value)?;
//             class.attrs3.push(Attribute3::BorderColor(BorderColor(r.1)));
...
//             class.class_style_mark2 |= StyleType::BorderTop as usize
//                 | StyleType::BorderRight as usize
//                 | StyleType::BorderBottom as usize
//                 | StyleType::BorderLeft as usize;
//         }
//         "border-width" => {
//             let [r1, r2, r3, r4] = parse_four_f32(value)?;
...
// 			class.class_style_mark1 |= StyleType::ClipPath as usize;
...
//                         class.class_style_mark1 |= StyleType::Blur as usize;
//                     }
//                     _ => (),
//                 };
//             }
