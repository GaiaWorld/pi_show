...
//  */
// use ecs::{CreateEvent, ModifyEvent, MultiCaseListener, EntityListener, SingleCaseListener, SingleCaseImpl, MultiCaseImpl, Event};
...
// impl<'a> MultiCaseListener<'a, Node, Opacity, (CreateEvent, ModifyEvent)> for OpacitySys{
