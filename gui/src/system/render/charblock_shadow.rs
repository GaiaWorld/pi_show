...
impl<C: Context + 'static, L: FlexNode + 'static> CharBlockShadowSys<C, L> {
    pub fn new() -> Self{
...
impl<'a, C: Context + 'static, L: FlexNode + 'static> Runner<'a> for CharBlockShadowSys<C, L>{
    type ReadData = (
...
// 插入渲染对象
impl<'a, C: Context + 'static, L: FlexNode + 'static> MultiCaseListener<'a, Node, CharBlock<L>, CreateEvent> for CharBlockShadowSys<C, L>{
    type ReadData = (
        &'a MultiCaseImpl<Node, TextShadow>,
        &'a MultiCaseImpl<Node, Font>,
        &'a MultiCaseImpl<Node, ZDepth>,
...
// 字体修改， 设置顶点数据脏
impl<'a, C: Context + 'static, L: FlexNode + 'static> MultiCaseListener<'a, Node, CharBlock<L>, ModifyEvent> for CharBlockShadowSys<C, L>{
    type ReadData = ();
...
// 删除渲染对象
impl<'a, C: Context + 'static, L: FlexNode + 'static> MultiCaseListener<'a, Node, CharBlock<L>, DeleteEvent> for CharBlockShadowSys<C, L>{
    type ReadData = ();
    type WriteData = &'a mut SingleCaseImpl<RenderObjs<C>>;
...
// 字体修改， 重新设置字体纹理
impl<'a, C: Context + 'static, L: FlexNode + 'static> MultiCaseListener<'a, Node, Font, ModifyEvent> for CharBlockShadowSys<C, L>{
    type ReadData = (
        &'a SingleCaseImpl<FontSheet<C>>,
        &'a MultiCaseImpl<Node, Font>,
    );
...
// 字体修改， 重新设置字体纹理
impl<'a, C: Context + 'static, L: FlexNode + 'static> MultiCaseListener<'a, Node, Font, CreateEvent> for CharBlockShadowSys<C, L>{
    type ReadData = (
        &'a SingleCaseImpl<FontSheet<C>>,
        &'a MultiCaseImpl<Node, Font>,
    );
...
// 插入渲染对象
impl<'a, C: Context + 'static, L: FlexNode + 'static> MultiCaseListener<'a, Node, TextShadow, CreateEvent> for CharBlockShadowSys<C, L>{
    type ReadData = (
        &'a MultiCaseImpl<Node, TextShadow>,
        &'a MultiCaseImpl<Node, Font>,
        &'a MultiCaseImpl<Node, ZDepth>,
...
// 删除渲染对象
impl<'a, C: Context + 'static, L: FlexNode + 'static> MultiCaseListener<'a, Node, TextShadow, DeleteEvent> for CharBlockShadowSys<C, L>{
    type ReadData = ();
    type WriteData = &'a mut SingleCaseImpl<RenderObjs<C>>;
    fn listen(&mut self, event: &DeleteEvent, _read: Self::ReadData, write: Self::WriteData){
        if let Some(item) = self.render_map.remove(event.id){
...
impl<'a, C: Context + 'static, L: FlexNode + 'static> MultiCaseListener<'a, Node, TextShadow, ModifyEvent> for CharBlockShadowSys<C, L>{
    type ReadData = (
        &'a MultiCaseImpl<Node, Opacity>,
        &'a MultiCaseImpl<Node, TextShadow>,
        &'a MultiCaseImpl<Node, Font>,
...
impl<'a, C: Context + 'static, L: FlexNode + 'static> MultiCaseListener<'a, Node, WorldMatrixRender, ModifyEvent> for CharBlockShadowSys<C, L>{
...
impl<'a, C: Context + 'static, L: FlexNode + 'static> MultiCaseListener<'a, Node, WorldMatrixRender, CreateEvent> for CharBlockShadowSys<C, L>{
    type ReadData = MatrixRead<'a>;
    type WriteData = &'a mut SingleCaseImpl<RenderObjs<C>>;
...
impl<'a, C: Context + 'static, L: FlexNode + 'static> CharBlockShadowSys<C, L>{
    fn modify_matrix(
        &self,
        id: usize,
...
fn modify_font<C: Context + 'static> (
    id: usize,
    item: &mut Item,
...
unsafe impl<C: Context + 'static, L: FlexNode + 'static> Sync for CharBlockShadowSys<C, L>{}
unsafe impl<C: Context + 'static, L: FlexNode + 'static> Send for CharBlockShadowSys<C, L>{}

impl_system!{
    CharBlockShadowSys<C, L> where [C: Context + 'static, L: FlexNode + 'static],
    true,
    {
