...
//     pub fn set_width(&mut self, width: f32){ self.0.setWidth(width); }
...
//     pub fn set_height(&mut self, height: f32){ self.0.setHeight(height); }
...
//     pub fn get_position_type(&mut self) -> PositionType { unsafe{ transmute(self.0.getPositionType()) } }
//     pub fn get_position(&mut self, edge: Edge) -> f32 { self.0.getPosition(edge as u8) }

//     pub fn get_align_content(&mut self) -> AlignContent { unsafe{ transmute(self.0.getAlignContent()) } }
//     pub fn get_align_items(&mut self) -> AlignItems { unsafe{ transmute(self.0.getAlignItems()) } }
//     pub fn get_align_self(&mut self) -> AlignSelf { unsafe{ transmute(self.0.getAlignSelf()) } }
//     pub fn get_flex_wrap(&mut self) -> FlexWrap { unsafe{ transmute(self.0.getFlexWrap()) } }
//     pub fn get_justify_content(&mut self) -> JustifyContent { unsafe{ transmute(self.0.getJustifyContent()) } }

//     pub fn get_margin(&mut self, edge: Edge) -> f32 { self.0.getMargin(edge as u8) }

//     pub fn get_flex_basis(&mut self) -> f32 { self.0.getFlexBasis() }
//     pub fn get_flex_grow(&mut self) -> f32 { self.0.getFlexGrow() }
//     pub fn get_flex_ghrink(&mut self) -> f32 { self.0.getFlexShrink() }

//     pub fn get_width(&mut self) -> f32 { self.0.getWidth() }
//     pub fn get_height(&mut self) -> f32 { self.0.getHeight() }

//     pub fn get_min_width(&mut self) -> f32 { self.0.getMinWidth() }
//     pub fn get_min_height(&mut self) -> f32 { self.0.getMinHeight() }

//     pub fn get_max_width(&mut self) -> f32 { self.0.getMaxWidth() }
//     pub fn get_max_height(&mut self) -> f32 { self.0.getMaxHeight() }

//     pub fn get_aspect_ratio(&mut self) -> f32 { self.0.getAspectRatio() }

//     pub fn get_border(&mut self, edge: Edge) -> f32 { self.0.getBorder(edge as u8) }

//     pub fn get_overflow(&mut self) -> Overflow { unsafe{ transmute(self.0.getOverflow()) } }
//     pub fn get_display(&mut self) -> Display { unsafe{ transmute(self.0.getDisplay()) } }

//     pub fn get_padding(&mut self, edge: Edge) -> f32 { self.0.getPadding(edge as u8) }

//     pub fn insert_child(&mut self, node: YgNodeP, index: usize){ self.0.insertChild(unsafe{transmute(node)}, index); }
//     pub fn remove_child(&mut self, node: &YgNodeP){ self.0.removeChild(&node.0); }

//     pub fn get_child(&mut self, index: usize) -> YgNodeP { YgNodeP::new(self.0.getChild(index)) }
//     pub fn get_parent(&mut self) -> YgNodeP { YgNodeP::new(self.0.getParent()) }
