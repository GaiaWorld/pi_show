...
impl FlexNode for YgNode {
    ...
    fn get_layout(&self) -> Layout {
        Layout{
            ...
            border_right: yoga::yg_node_layout_get_border(self.0, yoga::YGEdge::YGEdgeRight)/100.0,
            border_bottom: yoga::yg_node_layout_get_border(self.0, yoga::YGEdge::YGEdgeBottom)/100.0,
            padding_left: yoga::yg_node_layout_get_padding(self.0, yoga::YGEdge::YGEdgeLeft)/100.0,
            padding_top: yoga::yg_node_layout_get_padding(self.0, yoga::YGEdge::YGEdgeTop)/100.0,
            padding_right: yoga::yg_node_layout_get_padding(self.0, yoga::YGEdge::YGEdgeRight)/100.0,
            padding_bottom: yoga::yg_node_layout_get_padding(self.0, yoga::YGEdge::YGEdgeBottom)/100.0,
        }
    }
